...
function Profile() {
    ...
    return (
        ...
        >
            <GridItem colSpan={3} sx={profileCardMain}><ProfileInfo/></GridItem>
            <GridItem colSpan={1} sx={profileCard}> <  ProgressDoghnut /> </GridItem>
            <GridItem colSpan={1} sx={profileCard}> <TestReports/> </GridItem>
            <GridItem colSpan={1} sx={profileCard}> <RecoveryReport/> </GridItem>
        </Grid>
    );
}
